 ...
 */
export async function pdfMeta(buffer: Buffer, options?: ProcessingOptions): Promise<Record<string, unknown>> {
 ...
 */
export async function pdfExtractImages(buffer: Buffer, options?: ProcessingOptions): Promise<string[]> {
